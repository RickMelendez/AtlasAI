...
start "Atlas Backend" cmd /k "cd /d %~dp0backend && call venv\Scripts\activate && python -m uvicorn src.main:app --reload --host 0.0.0.0 --port 8000"
...
echo   Backend:  http://localhost:8000   (auto-reloads on .py changes)
